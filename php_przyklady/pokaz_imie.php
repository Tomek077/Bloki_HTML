...
/*
    ===================================================
    FILTROWANIE PO IMIENIU - WHERE + TABLICA INDEKSOWANA
    ===================================================

    Ten plik pokazuje uczniów o WYBRANYM imieniu.
    Używamy:
    ...
    KROKI:
    1. Połącz się z bazą
    2. Pobierz szukane imię z formularza
    3. Użyj WHERE w zapytaniu SQL
    4. Wyświetl tylko uczniów o tym imieniu używając [0], [1], [2]...
...
// ========== KROK 2: POBIERZ SZUKANE IMIĘ ==========
// $_POST['szukane_imie'] - nazwa MUSI być taka sama jak name="szukane_imie" w formularzu!

$imie = $_POST['szukane_imie'];

echo "<h1>👤 Uczniowie o imieniu: <span style='color: #9b59b6;'>$imie</span></h1>";

echo "<div class='info'>";
echo "<strong>KROK 1:</strong> Pobrano szukane imię z formularza<br>";
echo "Użyto: <code>\$imie = \$_POST['szukane_imie'];</code><br>";
echo "Wartość: <strong>$imie</strong>";
echo "</div>";


// ========== KROK 3: ZAPYTANIE SQL Z WHERE ==========
// WHERE imie = '$imie' - pokaż tylko uczniów gdzie imie = wybrana wartość
...
echo "<li><code><strong>WHERE imie = '$imie'</strong></code> - tylko tam gdzie imie = $imie</li>";
echo "</ul>";
echo "✨ <strong>WHERE imie filtruje po imieniu!</strong> Dzięki temu widzimy tylko uczniów o imieniu $imie!";
echo "</div>";
...
echo "🎯 Znaleziono uczniów: <strong>$ilosc</strong> o imieniu $imie";
echo "</div>";
...
if ($ilosc > 0) {
    // Są uczniowie o tym imieniu - pokaż tabelę
    ...
    echo "<div class='info'>";
    echo "✅ <strong>Sukces!</strong> Wyświetlono $ilosc uczniów o imieniu <strong>$imie</strong>.<br><br>";
    echo "<strong>🔑 Użyto:</strong><br>";
    echo "<ul>";
    echo "<li><code>WHERE imie = '$imie'</code> - do filtrowania po imieniu</li>";
    echo "<li><code>mysqli_fetch_row()</code> - tablica indeksowana [0], [1], [2]...</li>";
    echo "</ul>";
    echo "</div>";

} else {
    // Brak uczniów o tym imieniu
...
<span style="color: #95a5a6;">// 2. Pobierz szukane imię z formularza</span>
<span style="color: #e74c3c;">$imie = $_POST['szukane_imie'];</span>

<span style="color: #95a5a6;">// 3. Przygotuj zapytanie SQL z WHERE</span>
<span style="color: #e74c3c;">$sql = "SELECT * FROM uczniowie WHERE imie = '$imie'";</span>
