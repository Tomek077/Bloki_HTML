...
/*
    ===================================================
    FILTROWANIE PO NAZWISKU - WHERE + TABLICA INDEKSOWANA
    ===================================================
    ...
    KROKI:
    1. Połącz się z bazą
    2. Pobierz szukane nazwisko z formularza
...
// $_POST['szukane_nazwisko'] - nazwa MUSI być taka sama jak name="wybrana_klasa" w formularzu!
...
echo "<div class='info'>";
echo "<strong>KROK 1:</strong> Pobrano szukane nazwisko z formularza<br>";
echo "Użyto: <code>\$klasa = \$_POST['szukane_nazwisko'];</code><br>";
echo "Wartość: <strong>$klasa</strong>";
echo "</div>";


// ========== KROK 3: ZAPYTANIE SQL Z WHERE ==========
// WHERE nazwisko = '$klasa' - pokaż tylko uczniów gdzie klasa = wybrana wartość

$sql = "SELECT * FROM uczniowie WHERE nazwisko = '$klasa'";
...
echo "<li><code><strong>WHERE nazwisko = '$klasa'</strong></code> - tylko tam gdzie klasa = $klasa</li>";
echo "</ul>";
...
<span style="color: #95a5a6;">// 2. Pobierz szukane nazwisko z formularza</span>
<span style="color: #e74c3c;">$nazwisko = $_POST['szukane_nazwisko'];</span>

<span style="color: #95a5a6;">// 3. Przygotuj zapytanie SQL z WHERE</span>
<span style="color: #e74c3c;">$sql = "SELECT * FROM uczniowie WHERE nazwisko = '$klasa'";</span>
...
?&gt;</pre>
    ...
    <div class="info" style="margin-top: 30px;">
        ...
        <ol>
            ...
            <li>PHP złapał szukane nazwisko: <code>$_POST['szukane_nazwisko']</code></li>
            <li>PHP użył WHERE w zapytaniu: <code>WHERE nazwisko = '3A'</code></li>
...
<strong>WHERE nazwisko = '$klasa'</strong>
...
- itd.
        ...
        <h3>⚠️ SUPER WAŻNE:</h3>
        <ul>
            <li>✅ <code>$_POST['szukane_nazwisko']</code> musi być takie samo jak <code>name="wybrana_klasa"</code> w formularzu!</li>
